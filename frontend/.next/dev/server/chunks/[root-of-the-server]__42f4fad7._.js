...
"[project]/frontend/src/lib/mail.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createTransporter() {
    ...
    const transporter = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
        ...
        tls: {
            rejectUnauthorized: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : false
        },
...
"[project]/frontend/src/app/api/auth/send-otp/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$mail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/mail.ts [app-route] (ecmascript)");
;
;
;
const OTP_LENGTH = 6;
...
async function POST(req) {
    try {
        ...
        if (!email) return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].emailOtp.upsert({
                where: {
                    email
                },
                update: {
            ...
            const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].emailOtp.findFirst({
                where: {
                    email
                }
            });
            if (existing) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].emailOtp.update({
                    where: {
                        id: existing.id
                    },
                    data: {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].emailOtp.create({
                    data: {
                        email,
                        otp,
                        verified: false
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$mail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendOTPEmail"])(email, otp);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__42f4fad7._.js.map