...
"[project]/frontend/src/app/(authenticated)/admin/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminDashboard() {
    ...
    const [userSeries, setUserSeries] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [channelDistribution, setChannelDistribution] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [live, setLive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [intervalSec, setIntervalSec] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(5);
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[chartData]": ()=>{
            ...
            const tsSet = new Set();
            userSeries.forEach({
                "AdminDashboard.useMemo[chartData]": (u)=>u.points.forEach({
                        "AdminDashboard.useMemo[chartData]": (p)=>tsSet.add(p.ts)
                    }["AdminDashboard.useMemo[chartData]"])
            }["AdminDashboard.useMemo[chartData]"]);
            const tsArray = Array.from(tsSet).sort({
                "AdminDashboard.useMemo[chartData].tsArray": (a, b)=>a - b
            }["AdminDashboard.useMemo[chartData].tsArray"]);
            // produce rows: { tsLabel, [userId1]: count, [userId2]: count }
            return tsArray.map({
                "AdminDashboard.useMemo[chartData]": (ts)=>{
                    const row = {
                        ts,
                        tsLabel: new Date(ts).toLocaleTimeString()
                    };
                    for (const u_0 of userSeries){
                        const p_0 = u_0.points.find({
                            "AdminDashboard.useMemo[chartData].p_0": (x)=>x.ts === ts
                        }["AdminDashboard.useMemo[chartData].p_0"]);
                        row[u_0.userId] = p_0 ? p_0.count : 0;
                    }
                    return row;
                }
            }["AdminDashboard.useMemo[chartData]"]);
    ...
    const users = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[users]": ()=>userSeries.map({
                "AdminDashboard.useMemo[users]": (u_1)=>({
                        id: u_1.userId,
                        name: u_1.name
                    })
    ...
    async function fetchAnalytics() {
        ...
        try {
            ...
            // normalize
            const msgs = Array.isArray(j.messagesPerUser) ? j.messagesPerUser.map((u_2)=>({
                    userId: String(u_2.userId),
                    name: u_2.name ?? u_2.userId ?? "Unknown",
                    points: Array.isArray(u_2.points) ? u_2.points.map((p_1)=>({
                            ts: Number(p_1.ts),
                            count: Number(p_1.count)
                        })) : []
                })) : [];
            const channels = Array.isArray(j.channelDistribution) ? j.channelDistribution.map((c)=>({
                    channel: c.channel,
        ...
        "AdminDashboard.useEffect": ()=>{
            ...
            if (live) {
                timer = window.setInterval({
                    "AdminDashboard.useEffect": ()=>fetchAnalytics()
                }["AdminDashboard.useEffect"], Math.max(1000, intervalSec * 1000));
            }
            return ({
                "AdminDashboard.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            const wsUrl = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ANALYTICS_WS || "";
            if (!wsUrl) return;
            try {
                const ws = new WebSocket(wsUrl);
                wsRef.current = ws;
                ws.onopen = ({
                    "AdminDashboard.useEffect": ()=>console.debug("analytics ws open")
                })["AdminDashboard.useEffect"];
                ws.onmessage = ({
                    "AdminDashboard.useEffect": (ev)=>{
                        try {
                            ...
                            console.warn("ws parse err", e_1);
                        }
                    }
                })["AdminDashboard.useEffect"];
                ws.onclose = ({
                    "AdminDashboard.useEffect": ()=>console.debug("analytics ws closed")
                })["AdminDashboard.useEffect"];
            } catch (e_0) {
                console.warn("analytics ws init failed", e_0);
            }
            return ({
                "AdminDashboard.useEffect": ()=>{
                    try {
    ...
    function downloadCsv() {
        ...
        const header = [
            "timestamp",
            ...users.map((u_3)=>u_3.name)
        ];
        const rows = chartData.map((r)=>[
                new Date(r.ts).toISOString(),
                ...users.map((u_4)=>r[u_4.id] ?? 0)
            ]);
        const csv = [
            header.join(","),
            ...rows.map((row_0)=>row_0.join(","))
        ].join("\n");
        const blob = new Blob([
            csv
        ], {
        ...
        a_0.href = url;
        a_0.download = `messages_per_user_${new Date().toISOString()}.csv`;
        a_0.click();
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    ...
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 163,
                                    columnNumber: 13
                                }, this),
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm text-slate-600 mt-1",
                                    children: "Live analytics · Messages per user · Channel breakdown"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 164,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "px-3 py-1 rounded bg-white border shadow-sm text-sm",
                                    children: "Refresh"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 168,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>setLive((s)=>!s),
                                    className: `px-3 py-1 rounded text-sm ${live ? "bg-emerald-600 text-white" : "bg-white border"}`,
                ...
                error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-4 p-3 bg-rose-50 border border-rose-100 text-rose-700 rounded",
                    children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                            className: "lg:col-span-2 bg-white rounded-2xl p-6 shadow border border-slate-100",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            ...
                                            children: "Messages per user (live)"
                                        }, void 0, false, {
                                            fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                            lineNumber: 181,
                                            columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: "Tip: Use the legend to toggle users on/off. If many users exist, consider filtering or selecting top N users."
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 206,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                            className: "bg-white rounded-2xl p-6 shadow border border-slate-100",
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: channelDistribution.map((c_1, i_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            style: {
                                                                width: 12,
                                                                height: 12,
                                                                background: COLORS[i_1 % COLORS.length],
                                                                borderRadius: 3
                                                            }
                                                        }, void 0, false, {
                                                            fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-4 text-xs text-slate-500",
                                    children: "Shows per-channel user activity over the selected timeframe."
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 241,
                                    columnNumber: 13
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: "Users that sent messages during timeframe"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 249,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-xs text-slate-500",
                                    children: "Total messages (all channels)"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 253,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-2 text-xl font-bold",
                                    children: channelDistribution.reduce((s_0, c_2)=>s_0 + c_2.count, 0)
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 254,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-xs text-slate-400 mt-1",
                                    children: "Combined across channels"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 255,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            min: 1,
                                            value: intervalSec,
                                            onChange: (e_3)=>setIntervalSec(Number(e_3.target.value) || 5),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: "Lower interval gives near-real-time data but increases load."
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/(authenticated)/admin/page.tsx",
                                    lineNumber: 264,
                                    columnNumber: 13
...
_s(AdminDashboard, "fiToyKnVrXbf+UGeQ4xsHqQUSTo=");
_c = AdminDashboard;
var _c;
...
//# sourceMappingURL=frontend_src_app_%28authenticated%29_admin_page_tsx_df8f9a62._.js.map