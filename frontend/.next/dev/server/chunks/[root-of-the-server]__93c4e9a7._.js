...
async function POST(req) {
    try {
        const { email, name, sub, role } = await req.json();
        if (!email || !sub) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        res.headers.set("Set-Cookie", `token=${token}; Path=/; HttpOnly; Max-Age=${7 * 24 * 60 * 60}`);
        return res;
    } catch (err) {
