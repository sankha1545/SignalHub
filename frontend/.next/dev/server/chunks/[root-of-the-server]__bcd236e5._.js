...
async function POST(req) {
    try {
        ...
        if (!phone) return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const otp = genOtp();
        // persist OTP record
        await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].phoneOtp.create({
            data: {
                phone,
                otp,
                used: false
        ...
        const debugOtp = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : otp;
        return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            message: "OTP sent",
            debugOtp
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bcd236e5._.js.map