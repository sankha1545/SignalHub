...
"[project]/frontend/src/app/api/auth/google/signup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function adminExistsTx(tx) {
    const p = tx ?? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"];
    try {
...
async function POST(req) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
            where: {
                email
            },
            select: {
        ...
        if (requestedRoleForDb === "ADMIN") {
            try {
                const created = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6cba5a98._.js.map