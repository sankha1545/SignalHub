 ...
 */ function OtpInputGrid(t0) {
    ...
    if ($[0] !== "e98b07abeb3b67d43c25fb683146a5dce01cdfdd6fd67b7ed9151f93f7e3b075") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e98b07abeb3b67d43c25fb683146a5dce01cdfdd6fd67b7ed9151f93f7e3b075";
    }
...
function LoginPage() {
    ...
    async function onGoogleSuccess(credentialResponse) {
        ...
        let decoded;
        try {
            decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jwt$2d$decode$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jwtDecode"])(credentialResponse.credential);
        } catch (err_0) {
            console.error("jwt decode error", err_0);
        ...
        setBusy(true);
        try {
            const res_0 = await safeJsonFetch("/api/auth/google/login", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            if (!res_0.ok) {
                setError(res_0.data?.error ?? "Google login failed. If you don't have an account, sign up first.");
            } else {
                setSuccessMsg("Signed in with Google — redirecting…");
                setTimeout(()=>router.push("/welcome"), 600);
            }
        } catch (err_1) {
            console.error("google login error", err_1);
...
//# sourceMappingURL=_9f6bd050._.js.map