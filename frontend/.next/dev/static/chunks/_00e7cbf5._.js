...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (!res.ok) {
                // server returns helpful messages like "This account was created using google" etc.
                setError(data?.error ?? "Login failed. Please try again.");
            } else {
                setSuccessMsg("Signed in — redirecting…");
                // backend should set cookie; navigate after small delay for UX
    ...
    // Google sign-in success handler: POST to /api/auth/google/login
    async function onGoogleSuccess(credentialResponse) {
        ...
        // decode credential token (JWT) to extract email & sub
        let decoded;
        try {
        ...
        setBusy(true);
        try {
            const res_0 = await fetch("/api/auth/google/login", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            if (!res_0.ok) {
                // backend will respond with 403 (provider mismatch) or 404 (account not found)
                setError(data_0?.error ?? "Google login failed. If you don't have an account, sign up first.");
            } else {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen bg-gradient-to-b from-zinc-50 to-white dark:from-black dark:to-zinc-900 flex items-center justify-center py-12 px-4",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-lg p-8 ring-1 ring-black/5 dark:ring-white/6",
                        children: [
...
_s(LoginPage, "9psgCbgsZjhSnYCVvBHbrsObdDA=", false, function() {
    return [
...
//# sourceMappingURL=_00e7cbf5._.js.map